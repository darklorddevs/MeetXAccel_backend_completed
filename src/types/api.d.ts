 ...
 * 
 * This file contains TypeScript interfaces that mirror the Django backend
 * API responses and request payloads. These types ensure type safety
...
export interface EventType {
  ...
  description: string
  duration: 15 | 30 | 45 | 60 | 90 | 120 | 180 | 240
